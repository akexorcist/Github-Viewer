...
You (Orchestrator)
  ...
  │
  ├─► 03 Core Developer    → core_result.md + core module source
  ├─► 04 Feature Developer → feature_result.md + feature module source
  │     │                    (includes integration tests in :integration-test desktopTest)
  │     │
  │     └─► Run: ./gradlew :integration-test:desktopTest
  │           │
  │           ├─ FAIL ─► back to 04 Feature Developer to fix (non-UI layer broken)
  │           │
  │           └─ PASS ─► 05 App Integrator    → integrator_result.md + app module wired
...
1. Update shared_context.md:
   ...
   - Resource Registry: every new resource entry
...
| 03 Core Developer         | PROJECT_CONFIG.md path, blueprint.md path                                                |
| 04 Feature Developer      | PROJECT_CONFIG.md path, blueprint.md path                                                |
| 05 App Integrator         | PROJECT_CONFIG.md path, blueprint.md path                                                |
